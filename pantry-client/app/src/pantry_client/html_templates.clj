(ns pantry-client.html-templates
  (:use [io.pedestal.app.templates :only [tfn dtfn tnodes]]))

(defmacro pantry-client-templates
  []
  ;; Extract the 'hello' template from the template file pantry-client.html.
  ...
  ;;
  ;; app/src/pantry_client/rendering.cljs
  ;;
  ...
  {:pantry-client-page (dtfn (tnodes "pantry-client.html" "hello") #{:id})})
