  ...
  {:pantry-client
   {;; :build contains parameters which are passed to the build
    :build {;; :watch-files contains a list of files to watch for
            ...
            ;; the templates.
            :triggers {:html [#"pantry_client/rendering.js"]}}
    ...
    :built-in {:render {;; The directory where rendering scripts will
                        ...
                        :renderer 'pantry_client.rendering
    ...
    :aspects {;; Add an aspect that uses the data renderer
              ...
              :development {:uri "/pantry-client-dev.html"
                            :name "Development"
                            :out-file "pantry-client-dev.js"
                            :main 'pantry_client.start
                            :logging? true
                            :order 3}
              :fresh {:uri "/fresh.html"
                      ...
                      :order 4
                      :output-root :tools-public}
              :production {:uri "/pantry-client.html"
                           :name "Production"
                           :optimizations :advanced
                           :out-file "pantry-client.js"
                           :main 'pantry_client.start
                           :order 5}}}})
